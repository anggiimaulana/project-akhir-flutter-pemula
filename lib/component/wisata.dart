...
import 'package:myindramayu_flutter/pages/detail_wisata_screen.dart';
        ...
        LayoutBuilder(
          builder: (context, constraints) {
            ...
            return GridView.builder(
              ...
              itemCount: wisataPlace.length,
              itemBuilder: (context, index) {
                final item = wisataPlace[index];
                return Container(
                  ...
                  child: InkWell(
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => DetailWisataScreen(place: item),
                        ),
                      );
                    },
                    child: Column(
